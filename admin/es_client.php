					...
					<form method="post" id="Client-Form">
						...
						<ul class="nav nav-tabs" role="tablist">
						  ...
						  <li class="nav-item" id="tab8">
						    <a class="nav-link" data-toggle="tab" href="#Client-Tab8" role="tab">Parentesco</a>
						  </li>
						</ul>
						...
						<div class="tab-content" id="Client-View-Tabs">
							...
							<div class="tab-pane" id="Client-Tab8">
								<div class="row">
									<div class="col-7">
								...
								<div class="row">
									<div class="col-7">
										<label for="recipient-name" class="control-label">Nome completo do c�njuge</label>
								...
								<div class="row">
									<div class="col-7">
										<label for="recipient-name" class="control-label">Nome completo do av� ou av�</label>
								...
								<div class="row">
									<div class="col-7">
										<label for="recipient-name" class="control-label">Nome completo do bisav� ou bisav�</label>
